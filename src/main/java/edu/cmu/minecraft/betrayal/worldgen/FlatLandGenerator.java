...
public class FlatLandGenerator extends ChunkGenerator {
	...
	@Override
	public ChunkData generateChunkData(World world, Random random, int chunkX,
	...
	/**
	 * Fills a chunk with a layer of height (endY - startY) with the given
	 * material
	 * 
	 ...
	 */
	private void fillToHeight(ChunkData chunk, Material material, int startY,
			int endY) {
		chunk.setRegion(0, startY, 0, CHUNK_WIDTH, endY, CHUNK_HEIGHT,
				material);
	}
